...
const display_data=(i)=>{
    return(
            <div className="card border-primary mb-3" style={{maxWidth:"19rem",display:"flex",alignItems:"center",justifyContent:"center"}}>
                <div className="card-body text-primary">
                    <h5 className="card-title">CLASS - {i}</h5>
                    <p className="card-text">
                        <a className="text-danger" href="./sample2.pdf" target="_blank">View
                            PDF</a>
                        <br />
                        <a className="text-info-emphasis" href="./sample2.pdf"
                            target="_blank" download>Download PDF</a>
                    </p>
                </div>
            </div>
    )
...
const Marks = () => {
  return (
    <>
    <div className="row d-flex align-items-center justify-content-center mt-5 ml-auto">
